            ...
            <div class="w-full overflow-x-auto">
                <div class="flex justify-center min-h-screen">
                    <div class="text-center p-4">
                        ...
                        <h1 class="text-6xl font-black text-gray-800">401</h1>
                        <h2 class="text-2xl mt-4 mb-2 font-semibold text-gray-700">Requerimientos Faltantes</h2>
                        <p class="mb-6 text-gray-600">Lo sentimos, ¡no cuenta con los credenciales suficientes!
                            ¿pongase en contacto con el Administrador Principal?</p>
