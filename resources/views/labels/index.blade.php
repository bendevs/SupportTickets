                        ...
                        @forelse($labels as $label)
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 space-x-2">
                                    ...
                                    <form action="{{ route('labels.destroy', $label) }}" method="POST" onsubmit="return confirm('Esta seguro en eliminar esta etiqueta?')" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <x-primary-button>
                                            Eliminar
